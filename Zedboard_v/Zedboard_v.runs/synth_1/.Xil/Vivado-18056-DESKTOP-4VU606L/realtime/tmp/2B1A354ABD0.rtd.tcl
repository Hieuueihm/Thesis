...
set genomeRtd $env(RT_TMP)/2B1A354ABD0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Joint_histogram}]"
...
set genomeName [subst -nocommands -novariables {Joint_histogram}]
