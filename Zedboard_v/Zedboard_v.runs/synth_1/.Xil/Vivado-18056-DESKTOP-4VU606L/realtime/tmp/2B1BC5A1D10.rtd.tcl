...
set genomeRtd $env(RT_TMP)/2B1BC5A1D10.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Median_filter_7x7_calc__GCB3}]"
...
set genomeName [subst -nocommands -novariables {Median_filter_7x7_calc__GCB3}]
