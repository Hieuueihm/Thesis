...
set genomeRtd $env(RT_TMP)/2B19D0309B0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Median_filter_5x5_calc}]"
...
set genomeName [subst -nocommands -novariables {Median_filter_5x5_calc}]
