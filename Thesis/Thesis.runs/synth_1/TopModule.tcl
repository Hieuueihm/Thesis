...
namespace eval ::optrace {
  variable script "D:/Thesis/Thesis/Thesis.runs/synth_1/TopModule.tcl"
...
set_property webtalk.parent_dir D:/Thesis/Thesis/Thesis.cache/wt [current_project]
set_property parent.project_path D:/Thesis/Thesis/Thesis.xpr [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language Verilog [current_project]
set_property board_part xilinx.com:zcu106:part0:2.6 [current_project]
set_property ip_output_repo d:/Thesis/Thesis/Thesis.cache/ip [current_project]
...
read_xdc D:/Thesis/Thesis/Thesis.srcs/constrs_1/new/Constraints.xdc
set_property used_in_implementation false [get_files D:/Thesis/Thesis/Thesis.srcs/constrs_1/new/Constraints.xdc]

set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental D:/Thesis/Thesis/Thesis.srcs/utils_1/imports/synth_1/TopModule.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top TopModule -part xczu7ev-ffvc1156-2-e
